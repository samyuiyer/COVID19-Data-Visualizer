...
/**
 * The Table class is a table representation of the COVID-19 data
 */
public class Table extends DisplayMode {
	...
	private void setupSettings() {
		...
		settingsPane.getChildren().addAll(sliderLabel, timeSlider, timeLabel, cityFilter, stateFilter, countryFilter,
				setFilter, resetFilter);
	}

	/**
	 * @return the initial data from the table
	 */
